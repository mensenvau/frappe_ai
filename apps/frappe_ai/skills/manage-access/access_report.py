# Access audit/risk report for the Frappe AI site.
#
...
def run():
    ...
    # 3) App DocTypes with NO permission rule (inaccessible) — Frappe AI module only.
    fa_doctypes = frappe.get_all(
        "DocType", filters={"module": "Frappe AI", "istable": 0}, pluck="name"
    )
