...
Permissions** on DocTypes. Mason is default-deny — start from nothing and grant
...
- [`../../RULES.md`](../../RULES.md)
- Existing `mason/fixtures/role.json` / `custom_docperm.json` to avoid clashes.
