...
| crm | built | clients (individual/company) | [crm/SKILL.md](databek/crm/SKILL.md) |
| projects | built | projects per client + statuses | [projects/SKILL.md](databek/projects/SKILL.md) |
-->
