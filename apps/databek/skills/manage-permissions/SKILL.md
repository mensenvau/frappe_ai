...
Permissions** on DocTypes. Databek is default-deny — start from nothing and grant
...
- [`../../RULES.md`](../../RULES.md)
- Existing `databek/fixtures/role.json` / `custom_docperm.json` to avoid clashes.
