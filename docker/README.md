...
The `mason` app at `../apps/mason` is **bind-mounted** into the bench, so edits
...
- **First run** — inits the bench, creates the empty site, installs `mason`,
